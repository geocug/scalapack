...
*  =======
*
*  PDGBDRIVER is a test program for the
*  ScaLAPACK Band Cholesky routines corresponding to the options
*  indicated by DGB.  This test driver performs an
*  A = L*U factorization
...
*     .. External Subroutines ..
     ...
     $                   PDCHEKPAD, PDDBLASCHK, PDFILLPAD, PDGBINFO,
     $                   PDGBTRF, PDGBTRS, PDMATGEN, SLBOOT, SLCOMBINE,
     $                   SLTIMER
*     ..
*     .. External Functions ..
      INTEGER            NUMROC
...
*
      ...
      IBSEED = 200
*
      CALL PDGBINFO( OUTFILE, NOUT, TRANS, NMAT, NVAL, NTESTS, NBW,
...
*
     ...
     $               WRITE( NOUT, FMT = 9997 ) 'MEMORY'
               ...
               END IF
*
               CALL PDBMATGEN( ICTXT, 'G', 'N', BWL, BWU, N,
...
*
               CALL SLTIMER( 1 )
*
               CALL PDGBTRF( N, BWL, BWU, MEM( IPA ), 1, DESCA, IPIV,
...
*
                  CALL PDCHEKPAD( ICTXT, 'PDGBTRF', NP,
...
*
                     CALL PDGBTRS( TRANS, N, BWL, BWU, NRHS, MEM( IPA ),
...
*
                        CALL PDCHEKPAD( ICTXT, 'PDGBTRS-work',
     $                                  WORKSIZ, 1,
     $                                  MEM( IP_DRIVER_W-IPREPAD ),
     $                                  WORKSIZ, IPREPAD,
     $                                  IPOSTPAD, PADVAL )
