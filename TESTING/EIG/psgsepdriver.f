...
*     for operating system, the BLACS buffer, etc.  INTSIZ and REALSZ
*     indicate the length in bytes on the given platform for an integer
*     and a single precision real.
...
*     ============
*
*     This routine tests PSSYGVX, the expert driver for the parallel
...
*
     ...
     $      'generalized ' // 'symmetric eigenvalue routine:  PSSYGVX.'
     ...
     $      'reorthogonalized for lack of workspace.'
         WRITE( NOUT, FMT = 9999 )
     $      'TYP      : matrix type (see pSGSEPtst.f).'
         WRITE( NOUT, FMT = 9999 )
...
*
      ...
      ISEED( 4 ) = 3139
*
      CALL PSGSEPREQ( NIN, MEM, MEMSIZ, NOUT, ISEED, NTESTS, NSKIPPED,
