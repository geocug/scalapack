...
*     May 1, 1997
*
*     Parallel REAL symmetric eigenproblem test driver
*
...
*     for operating system, the BLACS buffer, etc.  INTSIZ and REALIZ
...
*     REAL words and 6*n integer words.
*     So, TOTMEM should be set to at least 1.1 * 8 * (5n + 5n^2/p)
*
*     WHAT WE TEST
*     ============
*
*     This routine tests PSSYEVX, the expert driver for the parallel
*     symmetric eigenvalue problem, and PSSYEV.  We would like to cover
*     all possible combinations of:  matrix size, process configuration
...
*
*     As PSSYEV returns an error message when heterogeneity is detected,
*     the PSSYEV tests can be suppressed by changing the appropiate
...
*
      ...
      ISEED( 4 ) =     583
*
      CALL PSSEPREQ( HETERO, NIN, MEM, MEMSIZ, NOUT, ISEED, NTESTS,
